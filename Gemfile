...
gem 'jbuilder', '~> 2.10', '>= 2.10.1' # Standard part of Rails, but unused, since we don't have an API.
gem 'jquery-rails', '~> 4.4', '>= 4.4.0' # JQuery on Rails.
gem 'pg', '~> 1.0' # PostgreSQL support.
gem 'pg_search', '~> 2.3', '>= 2.3.3' # builds ActiveRecord named scopes that take advantage of PostgreSQL's full text search.
gem 'activerecord-precounter', '~> 0.4', '>= 0.4.0' # N+1 count query optimizer for ActiveRecord.
gem 'sass-rails', '>= 6'
...
gem 'friendly_id', '~> 5.4.0' # Slugs for links. http://norman.github.io/friendly_id
...
gem 'file_validators', '~> 3.0', '>= 3.0.0' # Adds file validators to ActiveModel.
gem 'pundit', '~> 2.1', '>= 2.1.1' # Minimal authorization through OO design and pure Ruby classes.
...
group :development do
  ...
  gem 'bullet', '~> 6.1', '>= 6.1.1' # Detect N+1 queries.
...
group :production do
  ...
  gem 'skylight', '~> 4.3', '>= 4.3.0' # Skylight is a smart profiler for Rails, Sinatra, and other Ruby apps.
