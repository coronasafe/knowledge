...
gem 'fastimage', '~> 2.1'
gem 'image_processing', '~> 1.12', '>= 1.12.2' # Gem to support variants in ActiveStorage
...
gem 'puma', '~> 4.3', '>= 4.3.12' # The Puma ruby web server.
...
gem 'kramdown', '~> 2.3', '>= 2.3.1' # kramdown is a fast, pure Ruby Markdown superset converter, using a strict syntax definition and supporting several common extensions. http://kramdown.gettalong.org
...
gem 'chartkick', '~> 3.4', '>= 3.4.0' # Create beautiful charts with one line of JavaScript.
...
group :test do
  ...
  gem 'webdrivers', '~> 4.2', '>= 4.2.0' # Keep your Selenium WebDrivers updated automatically.
  ...
  gem 'diffy', '~> 3.4', '>= 3.4.1' # Easy Diffing in Ruby. https://github.com/samg/diffy
end
...
group :development, :test do
  ...
  gem 'rubocop', '~> 0.82', '>= 0.82.0', require: false # Ruby Style Guide.
...
group :production do
  ...
  gem 'dalli', '~> 3.2', '>= 3.2.3' # High performance memcached client for Ruby. https://github.com/petergoldstein/dalli
