...
gem 'active_storage_validations', '~> 0.8', '>= 0.8.9' # Better validations for active_storage.
gem 'fastimage', '~> 2.1'
gem 'image_processing', '~> 1.2' # Gem to support variants in ActiveStorage

# Use Webpack to manage app-like JavaScript modules in Rails.
gem 'webpacker', '~> 5.1', '>= 5.1.0'
...
gem 'jquery-rails', '~> 4.4', '>= 4.4.0' # JQuery on Rails.
...
gem 'bootstrap', '>= 4.5.0' # Official Sass port of Bootstrap.
gem 'autoprefixer-rails', '~> 9.4' # Autoprefixer for Ruby and Ruby on Rails.
gem 'bootstrap_form', '~> 4.5', '>= 4.5.0' # a Rails form builder that makes it super easy to create beautiful-looking forms using Bootstrap 4
...
gem 'roadie-rails', '~> 2.3', '>= 2.3.0' # CSS management for e-mails.
...
gem 'font-awesome-rails', '~> 4.7', '>= 4.7.0.8' # Icons from font-awesome!
...
gem 'react-rails', '~> 2.6', '>= 2.6.2' # For automatically transforming JSX and using React in Rails.

gem 'ahoy_matey', '~> 3.0', '>= 3.0.0' # Analytics for Rails.
...
gem 'postmark-rails', '~> 0.21', '>= 0.21.0' # Official integration library for using Rails and ActionMailer with the Postmark HTTP API.
...
gem 'responders', '~> 3.0', '>= 3.0.1' # A set of Rails responders to dry up your application (respond_to / with)
...
gem 'kaminari', '~> 1.2', '>= 1.2.1' # Scope & Engine based, clean, powerful, customizable and sophisticated paginator.
...
# Omniauth providers
gem 'omniauth-google-oauth2', '~> 0.8', '>= 0.8.1' # Oauth2 strategy for Google
gem 'omniauth-facebook', '~> 7.0', '>= 7.0.0' # Facebook OAuth2 Strategy for OmniAuth http://mkdynamic.github.com/omniauth-facebook
gem 'omniauth-github', '~> 2.0', '>= 2.0.0' # GitHub strategy for OmniAuth

gem 'pretender', '~> 0.4.0' # Log in as another user in Rails
...
gem 'rack-cors', '~> 2.0', '>= 2.0.0', require: 'rack/cors' # Rack Middleware for handling CORS, required to serve static assets such as fonts
...
group :development do
  gem 'letter_opener_web', '~> 1.4', '>= 1.4.1' # A web interface for browsing Ruby on Rails sent emails.
  gem 'bullet', '~> 6.1' # Detect N+1 queries.
  gem 'web-console', '~> 4.0', '>= 4.0.2' # Rails Console on the Browser.
  gem 'listen', '>= 3.0.5', '< 3.2' # The Listen gem listens to file modifications and notifies you about the changes.

  # Go faster, off the Rails - Benchmarks for your whole Rails app
  gem 'derailed_benchmarks', '~> 1.8', '>= 1.8.0'
  ...
  gem 'meta_request', '~> 0.7', '>= 0.7.4' # Chrome extension for Rails development. https://github.com/dejan/rails_panel
...
group :test do
  ...
  gem 'factory_bot_rails', '~> 5.2', '>= 5.2.0' # A library for setting up Ruby objects as test data.
  gem 'capybara', '~> 3.32', '>= 3.32.2' # For RSpec feature tests.
  gem 'capybara-email', '~> 3.0', '>= 3.0.2' # Test ActionMailer and Mailer messages with Capybara
  gem 'webdrivers', '~> 4.3', '>= 4.3.0' # Keep your Selenium WebDrivers updated automatically.
  gem 'capybara-screenshot', '~> 1.0', '>= 1.0.25' # Save screenshots on failure!
  gem "cuprite", "~> 0.10", require: false # Headless Chrome driver for Capybara.
...
group :development, :test do
  ...
  gem 'rspec-rails', '~> 4.0', '>= 4.0.1' # RSpec for Rails 5+.
  ...
  gem 'rubocop-rails', '~> 2.6', '>= 2.6.0', require: false # A RuboCop extension focused on enforcing Rails best practices and coding conventions.
...
group :production do
  ...
  gem 'heroku-deflater', '~> 0.7', '>= 0.7.0' # Enable gzip compression on heroku, but don't compress images.
